...
**Export:** Dateinamen-Schema wählbar unter **Optionen → Export** (z. B. `22_KUHN_EHCB`). **Druckformat** (200×55 mm / 289×36 mm / 200×36 mm Sticker) ist dort direkt sichtbar und stellt auch den Editor-Canvas um, damit Vorschau, Drag-Positionen und PDF-Ausgabe dasselbe Seitenverhältnis nutzen. Bei 289×36 mm und 200×36 mm werden auf A4 quer mehrere Schilder pro Bogen mit Schnittmarken platziert; separate Canva-Einzelseiten werden für diese Formate nicht angehängt. Batch-Export zeigt einen Fortschrittsbalken.
