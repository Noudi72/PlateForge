...
**Export:** Dateinamen-Schema wählbar unter **Optionen → Export** (z. B. `22_KUHN_EHCB`). **Druckformat** (200×55 mm / 289×36 mm) ist dort direkt sichtbar — für **📄 PDF Druck** oder Format **PDF (Druck)**. Batch-Export zeigt einen Fortschrittsbalken.
